...
Portanto, um uma perturbação eletromagnética gera um pulso se propaga pelo espaço.
Nessa sessão, será mostrado que essa propagação dos campos $\mathbf E$ e $\mathbf B$ obedecem uma equação de onda da forma
\begin{equation}
...
\end{equation}
\noindent onde $\phi$ e $\mathbf A$ são respectivamente o potencial escalar e o potencial vetor.
